...
$query1 = "SELECT * FROM gene where entrezid='6257';";
$query2 = "SELECT * FROM gene where entrezid='5468';";
$query3 = "SELECT * FROM gene where entrezid='7849';";
$query4 = "SELECT * FROM gene where entrezid='6256';";
